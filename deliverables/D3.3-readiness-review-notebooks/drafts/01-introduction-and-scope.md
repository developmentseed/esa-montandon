...
Because the four are this tightly coupled, this report assesses readiness across all four rather than
treating D3.3 as an isolated engineering artefact. This scope was confirmed with the deliverable owner
ahead of drafting.
...
D2.x; this is noted for completeness and is not duplicated here, since it is assessed on its own terms
in D2.3.
...
(Section 5); and conclusions and next steps (Section 6). It does not re-assess the WP2 pipeline
architecture or use-case status, which are covered in D2.2 and D2.3 respectively, though it depends on
both.
