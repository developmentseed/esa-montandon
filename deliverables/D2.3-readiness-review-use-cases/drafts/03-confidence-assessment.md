...
remains is concentrated in three places: getting real CEMS and Charter data into production (CEMS has
...
and the inherent uncertainty of a best-effort, non-committal engagement.

## What would raise confidence

- **UC1** to very high: the baseline-computation strategy decided (Section 4).
- **UC2** to high: CEMS or Charter in production (Section 2.4), and one full run against the
  resulting live event, reviewed by an IFRC or MapAction domain expert.
- **UC3** to high: the Utility Report received.
